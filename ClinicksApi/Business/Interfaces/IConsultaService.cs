...
namespace ClinicksApi.Business.Interfaces
{
    ...
    public interface IConsultaService
    {
        ...
        Task<List<ConsultaHistorialDto>> ListaConsultas();
        ...
        /// </returns>
        Task<(bool Success, string Message, ConsultaMedica? Data)> RegistrarConsulta(ConsultaAltaDto consulta, int idMedico);
    }
}