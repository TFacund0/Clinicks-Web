  ...
  return (
    <header className="h-20 border-b border-slate-800 flex items-center justify-between px-8 bg-slate-950">
      ...
      <div className="flex items-center gap-4 bg-slate-900 px-4 py-2 rounded-xl border border-slate-800 w-96">
        ...
        <input type="text" placeholder="Buscar paciente..." className="bg-transparent border-none outline-none text-slate-300 w-full" />
      </div>
      ...
      <div className="flex items-center gap-6">
        ...
        <div className="flex items-center gap-3 border-l border-slate-800 pl-6">
          <img src="https://i.pravatar.cc/150?u=dr" alt="Profile" className="w-10 h-10 rounded-full border-2 border-cyan-500" />
